                ...
                <ul class="list-group mb-3">
                    <li class="list-group-item d-flex justify-content-between lh-condensed">
                        <div>
                            ...
                            <small class="text-muted">{{ $cart->categories->name }}</small>
                        </div>
                        <span class="text-muted">{{ $cart->categories->price }}</span>
                    </li>
                   
                    <li class="list-group-item d-flex justify-content-between">
                        <span>Total (BDT)</span>
                        <strong>{{ $cart->categories->price }} TK</strong>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="customer_mobile" class="form-control" id="mobile"
                                placeholder="Mobile" value="01478523568" required>
