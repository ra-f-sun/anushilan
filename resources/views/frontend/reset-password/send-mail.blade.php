...
<section class="recovery-area pt-200px pb-80px position-relative">
    <div class="container">
        <form action="{{ route('send.otp') }}" method="post" class="card card-item login-form" >
            @csrf
            <div class="card-body row p-0">
                <div class="col-lg-6">
                    <div class="form-content py-4 pr-60px pl-60px border-right border-right-gray h-100 d-flex align-items-center justify-content-center">
                        <img src="{{ asset('frontend/images/undraw-forgot-password.svg') }}" alt="Image" class="img-fluid">
                    </div>
                </div><!-- end col-lg-6 -->
                <div class="col-lg-5 mx-auto">
                    <div class="form-action-wrapper py-5">
                        ...
                        <div class="form-group">
                            <button id="send-message-btn" class="btn theme-btn w-100" type="submit">Send recovery email <i class="la la-arrow-right icon ms-1"></i></button>
                        </div><!-- end form-group -->
